...
使用Master选举出一台服务器用于计算热门新闻的排序，其他服务器只需获取结果即可，节省了大量的重复计算资源。

计算热门博客排序的时候，每一次都是Master选举，相较于事先指定某一台服务器进行更新，避免了指定服务器崩溃的带来的问题。
...
前端使用ajax进行异步提交，后台返回json字符串，可以避免频繁刷新页面，增加系统交互的友好度。
